...
proof are implemented locally; production deployment is still pending.
...
The page's API documentation link should open Swagger UI through the same Vite proxy. Detailed
...
1. finalize the Vercel frontend and API entry points;
2. link and deploy the frontend and API to Vercel;
3. test the page and both health endpoints in production;
4. configure the Meta App, OAuth callback, and comment webhook;
